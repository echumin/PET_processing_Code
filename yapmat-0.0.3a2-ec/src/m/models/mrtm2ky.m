function [BP, k2r, R1, k2, k2a] = mrtm2ky (fimg1, base, fCr, outdir, thalf, wmeth)
...
% Modified: 14 November 2012 by Karmen Yoder as mrtm2ky.m
%           (kkyoder@iupui.edu). 
%           Commenting out sampling for global k2ref and histogram generation.
%           Setting k2ref to a set value to test output of MRTM and MRTM2 BPnd values.          
...
%%%%%%%%%%%%%%%%  14 nov 2012 kky commenting out
%start kky comment
...
%% (already commented) print ('-dpng', fullfile (outdir, sprintf ('k2r-hist-MRTM-%s.png', wmeth)));
%% (already commentd) print ('-depsc', fullfile (outdir, sprintf ('k2r-hist-MRTM-%s.eps', wmeth)));
