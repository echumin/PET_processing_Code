function [BP, R1, k2, k2a] = mrtm_vox (dyn, Cr, ts, del, lambda, wmeth)

% File: mrtm_vox.m
%
% Description:
%   Facilitates the application of the multilinear reference tissue model (MRTM)
%   at each voxel in a dynamic image.  For more details on the MRTM, please 
%   refer to the documentation for file mrtm.m.
%
% Usage:
...
for x = 1:dim(1)
  fprintf ('\n  MRTM on sagittal slice number %d of %d ...', x, dim(1));
  for y = 1:dim(2)
    for z = 1:dim(3)
