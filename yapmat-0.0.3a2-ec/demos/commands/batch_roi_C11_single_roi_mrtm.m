...
%  MODIFY THESE VALUES  %
%%%%%%%%%%%%%%%%%%%%%%%%%
datadir = '/portal01/kkyoder/Raclopride_2008/PPE/2Aim/CONT/PPE20112_MR/Subcort_structural_ROI/Martinez_ROIs/Matrines_TACs/';
outdir = '/portal01/kkyoder/Raclopride_2008/PPE/2Aim/Binding Potentials/CONT/Martinez/PPE20112/';
pid = 'PPE20112';
thalf = 20.4
%%%%%%%%%%%%%%%%%%%%%%%%%
...
% fclose (fid);
%LR = {'L'; 'R'};
region_names = {'DCA_PET_corrected'; 'DPU_PET_corrected'; 'VST_PET_corrected'};
             
%tstar = 25;
             
%for ii = 1:length (LR)
  for jj = 1:length (region_names)
    region_file = strcat (pid, '-', region_names{jj}, '_roi.txt');
    Ct = fullfile (datadir, region_file);
    Cr = fullfile (datadir, strcat (pid, '-', 'BICEREB_roi.txt'));
