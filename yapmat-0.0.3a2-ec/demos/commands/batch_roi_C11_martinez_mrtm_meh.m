...
%  MODIFY THESE VALUES  %
%%%%%%%%%%%%%%%%%%%%%%%%%
datadir = '/portal01/kkyoder/Raclopride_2008/PPE/2Aim/CONT/PPE20125_MR/Subcort_structural_ROI/Martinez_ROI/Martinez_TAC/';
outdir = '/portal01/kkyoder/Raclopride_2008/PPE/2Aim/Binding Potentials/CONT/Martinez/PPE20125_2/';
pid = '2_PPE20125';
pid2 = 'PPE20125';
thalf = 20.4;
%%%%%%%%%%%%%%%%%%%%%%%%%
...
region_names = { 'Post_DCA'; 'Post_DPU'; 'Pre_DCA'; 'Pre_DPU'; 'VST'; 
 ...
 %tstar = 25;
  ...
  for jj = 1:length (region_names)
    ...
    Cr = fullfile (datadir, strcat (pid,'-', pid2,'_cereb_no_vermis_roi.txt'));
